...
void main() {
  ...
  group('Watchlist', () {
    test('should get the watchlist status', () async {
      // arrange
      when(mockGetWatchlistStatus.call(1)).thenAnswer((_) async => true);
      // act
    ...
    test('should execute save watchlist when function called', () async {
      // arrange
      when(mockSaveWatchlist.call(testTvDetail))
          .thenAnswer((_) async => Right('Success'));
      when(mockGetWatchlistStatus.call(testTvDetail.id))
    ...
    test('should execute remove watchlist when function called', () async {
      // arrange
      when(mockRemoveWatchlist.call(testTvDetail))
      ...
      // assert
      verify(mockRemoveWatchlist.call(testTvDetail));
    });
    ...
    test('should update watchlist status when add watchlist success', () async {
      ...
      await provider.addWatchlist(testTvDetail);
      // assert
      verify(mockGetWatchlistStatus.call(testTvDetail.id));
      expect(provider.isAddedToWatchlist, true);
